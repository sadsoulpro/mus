...
class ContactInfoAPITester:
    def __init__(self, base_url="https://dark-light-mode-2.preview.emergentagent.com/api"):
...
def main():
    ...
    print(f"Testing against: https://dark-light-mode-2.preview.emergentagent.com/api")
